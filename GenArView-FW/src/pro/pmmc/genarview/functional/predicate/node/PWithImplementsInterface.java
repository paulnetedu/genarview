...
public class PWithImplementsInterface extends PTypeHintPlain<Node> {

	public PWithImplementsInterface(TypeHintPlain hint) {
		super(hint);
	}
	...
	public boolean test(Node node) {
		...
		cu.accept(visitor);
		Map<String, String> map = visitor.getMapInterfaces();
		final String interfaceExp = values.get("interfaceName"); 
		for (String k : map.keySet()) {
			if (k.matches(interfaceExp)) {
				return true;
			}
		}
		return false;
